<%@ page language="C#" autoeventwireup="true" inherits="Plat_RegisterDetail, App_Web_piihyhzk" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div id="admin_div">
      <table class="table table-bordered table-hover table-striped">
        <tr>
          ...
          <td class="tdcontent"><asp:TextBox ID="UserName_T2" CssClass="form-control text_300" ReadOnly="true" runat="server" /></td>
        </tr>
        <tr>
          <td class="tdname">用户组：</td>
          <td class="tdcontent"><asp:TextBox ID="Plat_Group_T2" onkeydown="return GetEnterCode('focus','Status_T2');" CssClass="form-control text_300" Enabled="false" runat="server" /></td>
        </tr>
        <tr>
          <td class="tdname">状态：</td>
          <td class="tdcontent"><asp:TextBox ID="Status_T2" onkeydown="return GetEnterCode('focus','TrueName_T2');" CssClass="form-control text_300" runat="server" Enabled="false" Text="正常" /></td>
        </tr>
        <tr>
          <td class="tdname">真实姓名：</td>
          <td class="tdcontent"><asp:TextBox ID="TrueName_T2" onkeydown="return GetEnterCode('focus','Mobile_T2');" CssClass="form-control text_300" runat="server" />
        ...
        <tr>
          ...
          <td class="tdcontent"><asp:TextBox ID="Mobile_T2" onkeydown="return GetEnterCode('focus','Post_T2');" CssClass="form-control text_300" runat="server" /></td>
        </tr>
        <tr>
          <td class="tdname">工作岗位：</td>
          <td class="tdcontent"><asp:TextBox ID="Post_T2" onkeydown="return GetEnterCode('click','Save_Btn');" CssClass="form-control text_300" runat="server" /></td>
        </tr>
        <tr>
