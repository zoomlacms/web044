<%@ page language="C#" autoeventwireup="true" inherits="Plat_Group_CompDetail, App_Web_papgvydn" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div id="Comp_Body">
            <table class="table table-bordered table-hover table-striped">
                <tr>
                    ...
                    <td><asp:TextBox runat="server" onkeydown="return GetEnterCode('focus','CreateTime_T');" ID="CompName_T" CssClass="form-control text_300"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="menu">创建人：</td>
                    <td><asp:TextBox runat="server"  ID="CompUser_T" CssClass="form-control text_300" ReadOnly="true"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class="menu">创建时间：</td>
                    <td>
                        <asp:TextBox runat="server" ID="CreateTime_T" onkeydown="return GetEnterCode('focus','UrlCompLog');" CssClass="form-control text_300"></asp:TextBox></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="CompDesc_T" onkeydown="return GetEnterCode('focus','TxtCompType');" CssClass="form-control text_300"></asp:TextBox></td>
                </tr>
                <tr>
