<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Default, App_Web_arpdrlph" masterpagefile="~/User/Empty.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="OAtop">
	...
	<li><a href="#"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x"></i><i class="fa fa-tags fa-stack-1x fa-inverse"></i></span><br />个人助理</a></li>
	</ul>
	</div>
</div>
<div class="naver">
