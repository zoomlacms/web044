<%@ page language="C#" autoeventwireup="true" inherits="test_FlowApply_send, App_Web_sz0ss0uh" masterpagefile="~/Common/Common.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script>
    ...
    function ShowWord() {
        ShowDiag("/Plugins/Office/office.aspx?Action=add&ProID=<%=ProID%>&fname=" + $("#FName_Hid").val(), "正文管理");
    }
