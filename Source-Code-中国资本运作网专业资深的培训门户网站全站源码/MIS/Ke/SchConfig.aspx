<%@ page language="C#" autoeventwireup="true" inherits="test_test, App_Web_m0xbzz2w" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="text-center" style="position:fixed;bottom:2px; width:100%; background-color:white;padding:5px;border:1px solid #ddd;">
