<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_ExTeacherManage, App_Web_m0xbzz2w" validaterequest="false" enableviewstatemac="false" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <tr class="tdbg">
        ...
        <td height="22" colspan="8" align="center" class="tdbg">
          共<asp:Label ID="Allnum" runat="server" Text=""></asp:Label>条数据
                        ...
                        <asp:TextBox ID="txtPage" runat="server" AutoPostBack="true" OnTextChanged="txtPage_TextChanged" style="width:30px;"></asp:TextBox>
                        条数据/页 转到第
