<%@ page language="C#" autoeventwireup="true" inherits="Plat_DocContent, App_Web_m0xbzz2w" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
.td_content_div{padding:2px;padding-left:5px;border-radius:10px; background-color:#1796BF;margin-top:3px;margin-bottom:3px;height:25px;line-height:25px;color:white;text-align:center;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;}
...
<nav class="navbar navbar-default ">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-7">
         ...
         <ul class="nav navbar-nav pull-right right_option">
        ...
        $("#DateBody .datas").dblclick(function () {
            ...
            if(flag==0){
                ...
                $(".formdate").datetimepicker({
                    ...
                    $("#txtEndTime").datetimepicker('setStartDate',$("#txtBeginTime").val());
                    $("#txtBeginTime").datetimepicker('setEndDate',$("#txtEndTime").val());
