<%@ page language="C#" autoeventwireup="true" inherits="Prompt_ShopCart_HotelForm, App_Web_grcl2peu" masterpagefile="~/Cart/order.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  ...
  <%--  <div><strong>保险数量:</strong><asp:TextBox runat="server" ID="Safenum_T" CssClass="form-control" /></div>--%>
    <div class="panel panel-primary">
        ...
        <li>
            <table class='table table-bordered'>
                <tr><td rowspan='2' class='r_green_mid min'>客人<span class='num'>1</span></td><td><input type='text' class='form-control required' name='name_t_1' placeholder='姓名' />
