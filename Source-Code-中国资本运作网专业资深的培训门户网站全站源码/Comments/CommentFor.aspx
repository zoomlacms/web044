<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Comment.CommentFor, App_Web_qtp403hp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html>
<head>
<title>发表评论</title>
<meta charset="utf-8">
        ...
        function Support(obj) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $(obj).find(".count").text(parseInt($(obj).find(".count").text()) + 1);
        ...
        function ContentAssist(flag) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data=="1"){
                        $(".info").css({ color:'#666',});
                        $("#"+idflag).find(".info_count").text(parseInt($("#setup").find("span").text())+1);
                    }
