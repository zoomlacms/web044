<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="manage_iServer_FiServer, App_Web_rmny4oxt" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="u_ban page_ban">
    <div class="container">
        ...
        <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/user/iServer/FiServer.aspx"><i class="fa fa-comments"></i><br/>有问必答</a></li>  
