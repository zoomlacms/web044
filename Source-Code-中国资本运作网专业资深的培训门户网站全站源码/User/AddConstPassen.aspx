<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_AddConstPassen, App_Web_oebotbm0" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="Name" runat="server" CssClass="form-control text_md"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="Name_EN" runat="server" CssClass="form-control text_md"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right" style="font-weight: bold;line-height:32px;">国籍: </td>
            <td>
                <asp:TextBox ID="Nation" runat="server" CssClass="form-control text_md"></asp:TextBox>
            </td>
        </tr>
        <tr>
            ...
            <td class="style2">
                <asp:DropDownList ID="CreID" CssClass="form-control text_md" Width="150" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="CreID1" runat="server" CssClass="form-control text_md pull-left"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="BirthDay" runat="server" CssClass="form-control text_md"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="FlyerCart" runat="server" CssClass="form-control text_md"></asp:TextBox>
            </td>
        </tr>
        <tr>
