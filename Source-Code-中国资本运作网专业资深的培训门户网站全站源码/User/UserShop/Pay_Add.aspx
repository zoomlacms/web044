<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserShop_Pay_Add, App_Web_yxfagal4" clientidmode="Static" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ContentTemplate>
                <table class="table table-bordered table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DDLPayPlat" runat="server" CssClass="form-control text_md" Width="160px" AutoPostBack="True" OnSelectedIndexChanged="DDLPayPlat_SelectedIndexChanged"></asp:DropDownList>
                            <asp:DropDownList ID="DDLPayType" CssClass="form-control text_md" runat="server" Width="130px"></asp:DropDownList>
                            <span><b>* </b>必选</span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="DDLPayName" runat="server" class="form-control text_md"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtAccountID" runat="server" class="form-control text_md" />
                            <span style="color: black">* 必填</span>
                    ...
                    <tr id="trMD5Key" runat="server">
                        ...
                        <td>
                            <asp:TextBox ID="TxtMD5Key" runat="server" class="form-control text_md" />
                            <span style="color: black">* 必填</span>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtSellerEmail" runat="server" class="form-control text_md" />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtRemark" runat="server" Text="" class="form-control text_md" TextMode="MultiLine" style="max-width:500px;" Height="144px" />
                        </td>
                    </tr>
                    <tr>
