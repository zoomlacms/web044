<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="AddProduct, App_Web_yxfagal4" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <table class="table table-striped table-bordered">
                    <tbody id="Tabs0" style="border-top:none;">
                        ...
                        <tr>
                            ...
                            <td style="width: 592px;">
                                <asp:TextBox ID="ProCode" runat="server" Width="200" class="form-control text_md" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Propeid" runat="server" Text="0" Width="51px" class="form-control text_md" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="BarCode" runat="server" Width="155px" class="form-control text_md" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="Proname" runat="server" Width="442px" class="form-control text_md" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Kayword" runat="server" Width="155px" class="form-control text_md" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:TextBox ID="ProUnit" runat="server" Width="155px" class="form-control text_md" Text="件" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Weight" runat="server" class="form-control text_md text_xs" />
                            ...
                            <td>
                                        ...
                                        <asp:View ID="View1" runat="server">
                                            <table id="tgTable" class="classdiv">
                                                <tr>
                                                    <td>团购订金：</td>
                                                    <td>
                                                        <asp:TextBox ID="txtColoneDeposit" runat="server" class="form-control text_md"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td>最低团购人数：</td>
                                                    <td>
                                                        <asp:TextBox ID="NumberText" runat="server" class="form-control text_md text_s" /><span>人</span>
                                                    </td>
                                                    <td>团购价格:</td>
                                                    <td>
                                                        <asp:TextBox ID="TGPrice" runat="server" class="form-control text_md text_s" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>开始时间</td>
                                                    <td>
                                                        <asp:TextBox ID="ColonelStartTimetxt" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" class="form-control text_md"></asp:TextBox>
                                                    </td>
                                                    <td>结束时间:</td>
                                                    <td>
                                                        <asp:TextBox ID="ColonelendTimetxt" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });" class="form-control text_md"></asp:TextBox>
                                ...
                                <table id="idcTable" class="classdiv">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="ServerPeriod" runat="server" class="form-control text_md text_xs" />
                                            <asp:DropDownList ID="ServerType" CssClass="form-control text_md text_x" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList runat="server" ID="expRemindDP" CssClass="form-control text_md text_x">
                    ...
                    <tbody id="Tabs1" style="border-top:none;display: none;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txt_Clearimg" runat="server" Width="300px" class="form-control text_md" />
                        ...
                        <tr id="addsmallimg">
                            ...
                            <td>
                                <asp:TextBox ID="txt_Thumbnails" runat="server" Width="300px" class="form-control text_md" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="ModeTemplate" runat="server" class="form-control text_md" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtCountHits" runat="server" class="form-control text_md text_md" Text="0" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td style=" width: 592px;">
                                <asp:TextBox ID="UpdateTime" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm' });" class="form-control text_md text_md" />
                            </td>
                        </tr>
                    </tbody>
                    <tbody id="Tabs2" style="border-top:none;display: none">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Producer" runat="server" Width="214px" class="form-control text_md"></asp:TextBox><a
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Brand" runat="server" Width="214px" class="form-control text_md"></asp:TextBox><a
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Quota" runat="server" Width="100px" class="form-control text_md">-1</asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="DownQuota" runat="server" Width="100px" class="form-control text_md">-1</asp:TextBox>
                                <span class="rd_green">  -1为不限制数量 0为不允许购买</span>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Stock" runat="server" Width="100px" class="form-control text_md" ClientIDMode="Static">10</asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td style=" width: 592px;">
                                <asp:TextBox ID="StockDown" runat="server" Width="100px" class="form-control text_md">1</asp:TextBox>
                    ...
                    <tbody id="Tabs3" style="border-top:none;display: none">
                        <tr>
                            ...
                            <td>
                                 <asp:TextBox ID="ShiPrice" runat="server" class="form-control text_md text_xs" Text="0" /><span>元</span>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:TextBox ID="LinPrice" runat="server" class="form-control text_md text_xs" /><span>元</span>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div id="userP" runat="server" style="display:none;">
                                    会员价：<asp:TextBox ID="userPrice" runat='server' class="form-control text_md text_xs"></asp:TextBox>元
                                ...
                                <div id="divGroup" runat="server" style="display: none;">
                                    <asp:Repeater ID="repGroup" runat="server">
                                        <ItemTemplate>
                                            ...
                                            <%#Eval("GroupName")%>：<asp:TextBox ID="GroupPrice" runat='server' class="form-control text_md text_xs"></asp:TextBox>元
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div id='hotelDiv'>
                                    <asp:TextBox ID='CheckInDate' runat="server" class="form-control text_md text_md" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm' });"></asp:TextBox>至
                                    <asp:TextBox ID='CheckOutDate' runat="server" class="form-control text_md text_md" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm' });"></asp:TextBox>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtRecommend" runat="server" Text="0"  class="form-control text_md text_s" /><span>%</span>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtPoint" runat="server" Text="0" class="form-control text_md text_s" />
                                    ...
                                    <tr id="pifaji" style="display: none" onmouseover="this.className='tdbgmouseover'"
                                        ...
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td>① 一次性购买此商品数量满
                                                    <asp:TextBox ID="s1" runat="server" Text='10' Width="49px" class="form-control text_md" />
                                                        时，批发价为
                                                    <asp:TextBox ID="j1" runat="server" Width="68px" class="form-control text_md">0</asp:TextBox>
                                                        元
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24">② 一次性购买此商品数量满
                                                    <asp:TextBox ID="s2" runat="server" Text='50' Width="49px" class="form-control text_md" />
                                                        时，批发价为
                                                    <asp:TextBox ID="j2" runat="server" Width="68px" class="form-control text_md">0</asp:TextBox>
                                                        元
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="24">③ 一次性购买此商品数量满
                                                    <asp:TextBox ID="s3" runat="server" Text='100' Width="49px" class="form-control text_md" />
                                                        时，批发价为
                                                    <asp:TextBox ID="j3" runat="server" Width="68px" class="form-control text_md">0</asp:TextBox>
                                                        元
                                                    </td>
                                                </tr>
                                            </table>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="Largesspirx" runat="server" Width="91px" class="form-control text_md">0</asp:TextBox>
                    ...
                    <tbody id="Tabs4" style="border-top:none;display: none">
                        <tr>
                            ...
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td height="22">&nbsp;买&nbsp;<asp:TextBox class="form-control text_md text_xs" ID="ProjectPronum2" Text="1" runat="server"></asp:TextBox>件此商品 可以送一件同样商品
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 22px">&nbsp;买&nbsp;<asp:TextBox Text="1" ID="ProjectPronum3" class="form-control text_md text_xs" runat="server"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td height="22">&nbsp;送&nbsp;<asp:TextBox ID="ProjectPronum4" class="form-control text_md text_xs" runat="server" Text="1"></asp:TextBox>件同样商品
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height: 22px">&nbsp;送&nbsp;<asp:TextBox ID="ProjectPronum5" runat="server" class="form-control text_md text_xs" Text="1"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td height="22">&nbsp;加&nbsp;<asp:TextBox ID="ProjectMoney6" class="form-control text_md text_xs" runat="server" Text="1"></asp:TextBox>元钱送商品 送一件赠品名称：<asp:TextBox ID="Productsname6" runat="server"
                                    ...
                                    <tr>
                                        <td height="22">&nbsp;满&nbsp;<asp:TextBox ID="ProjectMoney7" runat="server" Text="1" class="form-control text_md text_xs"></asp:TextBox>元钱送商品 送一件赠品名称：<asp:TextBox ID="Productsname7" class="form-control text_md"
                        ...
                        <tr>
                            ...
                            <td>购买&nbsp;<asp:TextBox ID="IntegralNum" runat="server" Text="1" class="form-control text_md text_xs"></asp:TextBox>&nbsp;件此商品可以得到
                            <asp:TextBox ID="Integral" runat="server" Width="53px" class="form-control text_md"
                                MaxLength="3" />
                                积分
