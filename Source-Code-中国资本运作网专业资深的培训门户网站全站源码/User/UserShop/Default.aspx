<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserShop_Default, App_Web_zxld4s1o" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script>
	...
	$().ready(function(e) {
		if($("#txt_logo").val()!="")
	        $("#shop_logo").attr("src",'/UploadFiles/'+$("#txt_logo").val());
    }); 
</script>
</asp:Content>