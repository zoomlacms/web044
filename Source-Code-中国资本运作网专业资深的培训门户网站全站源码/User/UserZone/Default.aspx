<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_UserZone_Default, App_Web_l1s0buqs" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="u_ban page_ban">
    <div class="container">
        ...
        <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/UserZone/Default.aspx"><i class="fa  fa-anchor"></i><br/>我的空间</a></li>  
        <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/Content/ECharts/AddChart.aspx"><i class="fa fa-users"></i><br/>社区交友</a></li>  
        <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/Content/ECharts/AddChart.aspx"><i class="glyphicon glyphicon-list-alt"></i><br/>问卷投票</a></li>  
        <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/Magazine/AddMagazine.aspx"><i class="glyphicon glyphicon-file"></i><br/>电子杂志</a></li>  
