<%@ page language="C#" autoeventwireup="true" inherits="User_Questions_ExamDetail, App_Web_ncs5hesm" enableviewstatemac="false" masterpagefile="~/User/Empty.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading navbar-fixed-top" id="quelist"><i class="fa fa-file-text-o"></i>
            ...
            <span runat="server" id="totalscore_sp" style="font-size:1.8em;"></span>
            <ul class="list-unstyled pull-right">
            <li><a href="/" title="首页"><i class="fa fa-home"></i></a></li>
            <li><asp:LinkButton runat="server" ID="Submit_Btn" OnClick="Submit_Btn_Click" OnClientClick="return PreSubmit();" ToolTip="交卷" ><i class="fa fa-check"></i>交卷</asp:LinkButton></li>
            <li class="hidden"><asp:LinkButton runat="server" ID="Coll_Btn" Visible="false" ><i class="fa fa-heart" title="收藏"></i></asp:LinkButton></li>
