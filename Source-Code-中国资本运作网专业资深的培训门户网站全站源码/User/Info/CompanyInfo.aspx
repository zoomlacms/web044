<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_CompanyInfo, App_Web_tqkgrgqt" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <div class="us_seta">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <td>公司Logo： </td>
                    <td>
                        <asp:FileUpload ID="FileUpload1" runat="server" class="form-control text_md" />
