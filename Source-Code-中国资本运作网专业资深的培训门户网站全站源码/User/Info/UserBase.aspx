<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Info_UserBase, App_Web_tqkgrgqt" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="container">
    ...
    <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/info/Userinfo.aspx"><i class="fa  fa-user"></i><br/>用户信息</a></li>  
    <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/Info/UserRecei.aspx"><i class="fa fa-users"></i><br/>我的地址簿</a></li>  
    <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/UserFunc/UserSignin.aspx"><i class="glyphicon glyphicon-edit"></i><br/>会员签到</a></li>   
    ...
    <div runat="server" id="DV_show">  
        ...
        <table style="width: 100%; margin: 0 auto;" cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td style="text-align: right">雅虎通帐号：
                    </td>
                    <td style="">
...
<script type="text/javascript" src="/JS/Controls/ZL_Dialog.js"></script>
    <script>
        ...
        function SetCutPic() {
            diag.title = "图片编辑";
            diag.width = "cutImg";
            diag.url = "/Plugins/PicEdit/CutPic.aspx?ipath=" + $("#face").attr("src");
            diag.ShowModal();
