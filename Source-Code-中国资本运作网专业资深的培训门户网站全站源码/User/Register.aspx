<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_aku3fss2" enableviewstatemac="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html lang="zh-CN">
<head>
...
<!--
    ...
    .reg_sub li input.codeok{background:url(/Install/images/right.gif) no-repeat;background-position:98% 8px;}
    .reg_sub li input.codeno{background:url(/App_Themes/AdminDefaultTheme/images/error.gif) no-repeat;background-position:98% 8px ;}
    </style>
    <script>
