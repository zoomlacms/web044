<%@ page language="C#" autoeventwireup="true" inherits="User_Exam_QuestRPT, App_Web_0xgpqldf" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <div class="panel-footer">
                 ...
                 <%--   <a href="#" class="disabled"><i class="fa fa-cloud-download"></i>下载</a>--%>
                    ...
                    <div style="float: right;">
                        ...
                        <span>知识点:<span class="r_green"><%#GetTestPoint(Eval("p_Knowledge", "{0}"))%></span></span>
                    </div>
                </div>
            </div>
        </ItemTemplate>
