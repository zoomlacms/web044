<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_Paper_QuestionManage, App_Web_0xgpqldf" enableviewstatemac="false" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="Papers_System_Manage.aspx"> 试卷标题：</a><asp:Label runat="server" ID="PTitle_L"></asp:Label> <a href='javascript:;' onclick='SelQuestion()'>[选择试题]</a></li>
    </ol>
