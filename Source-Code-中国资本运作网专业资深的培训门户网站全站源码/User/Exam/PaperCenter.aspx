<%@ page language="C#" autoeventwireup="true" inherits="User_Exam_PaperCenter, App_Web_0xgpqldf" masterpagefile="~/Common/Common.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div runat="server" id="add_div">
        <table class="table table-bordered table-striped table-hover">
            ...
            <tr><td>搭述:</td><td><asp:TextBox runat="server" ID="Desc_T" TextMode="MultiLine" CssClass="form-control m715-50" placeholder="描述主要用来方便查看您的试卷,描述内容可以是试卷题型和考点组成、难度、使用年级及时完成时间等"></asp:TextBox></td></tr>
