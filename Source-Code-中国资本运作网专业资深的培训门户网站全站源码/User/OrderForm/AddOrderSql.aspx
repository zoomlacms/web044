<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_AddOrderSql, App_Web_sqqxjjke" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        <table class="table table-bordered table-striped table-hover">
            <tr>
                ...
                <td>
                    <asp:DropDownList CssClass="form-control text_md" ID="OrderType" runat="server">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="UserName" runat="server" CssClass="form-control text_md"></asp:TextBox></td>
            </tr>
            <tr>
                <td width="15%" align="right">订单金额:</td>
                <td>
                    <asp:TextBox ID="money" runat="server" CssClass="form-control text_md"></asp:TextBox></td>
            </tr>
            <tr>
                <td width="15%" align="right">再次确认返分会员ID:</td>
                <td>
                    <asp:TextBox ID="PuserID" runat="server" CssClass="form-control text_md" AutoPostBack="True" OnTextChanged="PuserID_Changed"></asp:TextBox>*请再次录入会员ID：<%Call.Label("{$GetRequest(UID)$}"); %>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="PuserName" runat="server" CssClass="form-control text_md"></asp:TextBox>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="Sqlstr" runat="server" CssClass="form-control text_md" TextMode="MultiLine" Rows="20" Style="max-width:500px; height: 150px;" Text=" "></asp:TextBox></td>
            </tr>
            <tr>
                <td width="15%" align="right">备注:</td>
                <td>
                    <asp:TextBox ID="remark" runat="server" CssClass="form-control text_md"></asp:TextBox>
                </td>
            </tr> 
            <tr>
