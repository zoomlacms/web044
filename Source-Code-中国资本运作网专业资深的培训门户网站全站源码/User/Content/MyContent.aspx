<%@ page language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="ZoomLa.WebSite.User.Content.MyContentpage, App_Web_pl0nzqyk" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="u_ban page_ban">
    <div class="container">
        ...
        <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/Content/MyContent.aspx"><i class="glyphicon glyphicon-edit"></i><br/>投稿管理</a></li> 
        <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/iServer/FiServer.aspx"><i class="fa fa-comments-o"></i><br/>有问必答</a></li>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    ...
                    <ItemTemplate>
                        ...
                        <asp:LinkButton runat="server" CssClass="option_style" CommandName="Edit" CommandArgument='<%# Eval("GeneralID") %>' Visible='<%#GetIsNRe(Eval("Status", "{0}")) %>' ToolTip="修改"><i class="glyphicon glyphicon-pencil"></i></asp:LinkButton>
                        <a href="<%# GetUrl(Eval("Status", "{0}"))%>" class="option_style" target="_blank"><i class="fa fa-globe"></i>访问</a>
