<%@ page language="C#" autoeventwireup="true" inherits="Manage_ECartImg_ECharts, App_Web_v5xfexck" masterpagefile="~/User/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="u_ban page_ban">
    <div class="container">
        ...
        <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/Content/ECharts/AddChart.aspx"><i class="fa fa-comments"></i><br/>创建图表</a></li>  
        <li class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><a href="/User/Content/ECharts/AddChart.aspx"><i class="glyphicon glyphicon-th"></i><br/>图表列表</a></li>  
