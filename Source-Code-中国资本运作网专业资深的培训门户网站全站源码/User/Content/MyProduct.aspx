<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Content_MyProduct, App_Web_pl0nzqyk" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="us_pynews">
        <div class="us_seta">
            <ZL:ExGridView ID="EGV" runat="server" AutoGenerateColumns="False" PageSize="10" OnRowDataBound="EGV_RowDataBound"
                ...
                CssClass="table table-striped table-bordered table-hover" EnableTheming="False" EnableModelValidation="True" EmptyDataText="没有视频">
                <Columns>
