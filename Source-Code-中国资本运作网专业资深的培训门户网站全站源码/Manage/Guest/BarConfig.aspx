<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Guest_BarConfig, App_Web_bk2cq4rj" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="tab-pane active" id="basic">
        <table class="table table-bordered table-hover table-striped">
            ...
            <tr class="onlybar">
                ...
                <td>
                    <asp:TextBox runat="server" ID="BarOwner_T" ReadOnly="true" TextMode="MultiLine" CssClass="form-control text_md" />
