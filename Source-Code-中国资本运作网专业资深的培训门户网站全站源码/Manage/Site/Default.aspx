<%@ page language="C#" autoeventwireup="true" inherits="IISMain, App_Web_bg21zfm4" masterpagefile="~/Manage/I/Default.master" title="站点列表" enableviewstate="True" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ItemStyle CssClass="site_ico"></ItemStyle>
             ...
             <asp:TemplateField HeaderText="操作" ItemStyle-CssClass="site_a">
                 ...
                 <ItemTemplate>
                     ...
                     <a href="javascript:postToCS('stop','<%#Eval("SiteName") %>')"  title="停止" class="option_style"><i class="glyphicon glyphicon-pause"></i>停止</a>
                     <a href="javascript:postToCS('start','<%#Eval("SiteName") %>')" title="启动" class="option_style"><i class="glyphicon glyphicon-play"></i>启动</a>
