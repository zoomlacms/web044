<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Pub_PubInfo, App_Web_ojw4i0gm" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <ContentTemplate>
                ...
                <tr runat="server" id="PubNames">
                    ...
                    <td align="left" width="80%">
                        <asp:TextBox ID="PubName" runat="server"  style="width:349px;" AutoPostBack="True" CssClass="form-control pull-left" onkeyup="Getpy('PubName','PubTableName','PubLoadstr','PubInputLoadStr')"></asp:TextBox>
                        &nbsp;<font color="red">*</font>
                ...
                <tr runat ="server" id="PubIPOneOrMores">
                    ...
                    <td align="left" width="80%">
                        <span st yle="width: auto; float: left">
                ...
                <tr runat="server" id="Pubinfos">
                    ...
                    <td align="left" width="80%">
                        <asp:TextBox ID="Pubinfo" runat="server" style="width:349px;" CssClass="form-control pull-left" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
            </ContentTemplate>
        </asp:UpdatePanel>
