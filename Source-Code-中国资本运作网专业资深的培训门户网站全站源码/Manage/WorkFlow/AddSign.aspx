<%@ page language="C#" autoeventwireup="true" inherits="Manage_WorkFlow_AddSign, App_Web_fstfdkrf" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td>签章图：</td>
                <td>
                    <asp:TextBox ID="signPicT" CssClass="form-control text_300" runat="server" Visible="false"></asp:TextBox><br />
                    <asp:FileUpload runat="server" CssClass="text_300" Style="display: inline;" ID="signPic" /><span style="color: #f00">*</span>
                </td>
            </tr>
            <tr><td>签章密码:</td><td>
