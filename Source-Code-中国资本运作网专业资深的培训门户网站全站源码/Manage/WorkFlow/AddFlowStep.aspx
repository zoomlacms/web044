<%@ page language="C#" autoeventwireup="true" inherits="Manage_WorkFlow_AddFlowStep, App_Web_fstfdkrf" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <td>
                    <div style="margin-bottom: 10px;">
                        ...
                        <div class="input-group" style="width: 300px;">
                            <asp:TextBox runat="server" CssClass="form-control pull-left" ID="referUser_T" Enabled="false" />
            ...
            <tr>
                ...
                <td>
                    <div style="margin-bottom: 10px;">
                        <span class="pull-left text-right" style="width: 100px;">会员：</span>
                        <div class="input-group" style="width: 300px;">
                            <asp:TextBox CssClass="form-control" runat="server" ID="ccUser_T" Enabled="false" />
                            <span class="input-group-btn">
