<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelSql, App_Web_11fs3in2" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<WizardSteps>
  ...
  <asp:WizardStep ID="WizardStep2" runat="server" Title="step2">
	<table style="width: 100%;" cellpadding="2" cellspacing="1" class="table table-striped table-bordered">
	  ...
	  <tr>
		<td class="tdbg" colspan="2"><div style="width: 500px;margin-left:50px;">
  ...
  <asp:WizardStep ID="WizardStep3" runat="server" Title="step3">
	<table style="width: 100%;" cellpadding="2" cellspacing="1" class="table table-striped table-bordered">
		...
		<td class="tdbg"><table width="100%" border="0" cellpadding="0" cellspacing="1" class="table table-striped table-bordered" style="text-align: center">
		  ...
		  <table border="0" cellpadding="0" cellspacing="1" class="table table-striped table-bordered" style="text-align: center">
			<tr class="tdbg" align="center" style="height: 25px;">
			  ...
			  <td style="width: 80px; height: 25px"><asp:Button ID="BtnAddParam" runat="server" Text="添加" class="btn btn-info" OnClientClick="return VoteCheck();" OnClick="BtnAddParam_Click" Style="cursor: pointer;" /></td>
	  ...
	  <tr>
		<td colspan="2"><div style="width:500px;margin-left:50px;">
