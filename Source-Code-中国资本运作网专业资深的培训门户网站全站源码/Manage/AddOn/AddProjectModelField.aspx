<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="manage_AddOn_AddProjectModelField, App_Web_x3dzlpct" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control text_md" ID="Alias" runat="server" MaxLength="20"></asp:TextBox><font
        ...
        <tr>
            ...
            <td>
                <asp:TextBox CssClass="form-control text_md" ID="Name" MaxLength="50" runat="server"></asp:TextBox><font
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control text_md" ID="Tips" MaxLength="50" runat="server"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control text_md" ID="Description" runat="server" Columns="40" Rows="6" TextMode="MultiLine"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control text_md" ID="TextBox1" runat="server" Columns="10" MaxLength="4">10</asp:TextBox>%
            </td>
        </tr>
        ...
        <tbody id="DivTextType">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="TitleSize" runat="server" Columns="10" MaxLength="4">35</asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>是否为密码：
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="TextType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
                </td>
            </tr>
        </tbody>
        <!--  多行文本(不支持Html)    -->
        <tbody id="DivMultipleTextType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="MultipleTextType_Height" runat="server" Columns="10"
        ...
        <tbody id="DivMultipleHtmlType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="MultipleHtmlType_Width" runat="server" Columns="10"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="MultipleHtmlType_Height" runat="server" Columns="10"
        ...
        <tbody id="DivOptionType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="RadioType_Default" runat="server"></asp:TextBox>
        ...
        <tbody id="DivPicType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="TxtSPicSize" runat="server" Columns="5">1024</asp:TextBox>KB
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="TxtPicExt" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivMultiPicType" style="display: none">
            <tr>
                ...
                <td>
                    ...
                    <asp:TextBox class="form-control text_md" ID="TxtThumb" runat="server" Columns="20"></asp:TextBox><span
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="TxtPicSize" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="TextImageType" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody id="DivSmallFileType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="TxtMaxFileSizes" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="TxtUploadFileTypes" runat="server" Columns="30"></asp:TextBox>
        ...
        <tbody id="DivFileType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    ...
                    保存文件大小字段名：
                    <asp:TextBox class="form-control text_md" ID="TxtFileSizeField" runat="server" Columns="20"></asp:TextBox><br />
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="TxtMaxFileSize" runat="server" Columns="5">1024</asp:TextBox>KB
                    <span style="color: blue">提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> <span style="color: red">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="TxtUploadFileType" runat="server" Columns="30"></asp:TextBox>
                    <span style="color: red">*</span> <span style="color: Blue">注：允许多个类型请用“|”号分割，如：jpg|gif|bmp等等</span>
                </td>
            </tr>
        </tbody>
        ...
        <tbody id="DivOperatingType" style="display: none">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="OperatingType_TitleSize" runat="server" Columns="10"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="OperatingType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivSuperLinkType" style="display: none">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="SuperLinkType_TitleSize" runat="server" Columns="10"
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="SuperLinkType_DefaultValue" runat="server" Columns="30"></asp:TextBox><span
        ...
        <tbody id="DivGradeOptionType" style="display: none">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="GradeOptionType_Cate" CssClass="form-control text_md" runat="server"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>选项下拉框排列格式化：
        ...
        <tbody id="DivNumType" style="display: none">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="NumberType_TitleSize" runat="server" Columns="10"
            ...
            <tr id="showdec" style="display: none">
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="txtdecimal" runat="server" Text="0"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>默认值：
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="NumberType_DefaultValue" runat="server" Columns="10"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>搜索设置：
        ...
        <tbody id="DivColorType" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    <asp:TextBox class="form-control text_md" ID="ColorDefault" runat="server" MaxLength="7" Columns="7"></asp:TextBox>
