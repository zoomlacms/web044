<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.AddOn.GradeCateManage, App_Web_3vlerc2n" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<ZL:ExGridView ID="EGV" RowStyle-HorizontalAlign="Center" DataKeyNames="CateID" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="10"
	...
	<Columns> 
		...
		<asp:TemplateField HeaderText="操作">                
			<ItemTemplate>
				<asp:LinkButton runat="server" CommandName="Edit" CommandArgument='<%# Eval("CateID") %>'>修改</asp:LinkButton> | 
				<asp:LinkButton runat="server" CommandName="DicList" CommandArgument='<%# Eval("CateID") %>'>一级选项列表</asp:LinkButton>
			</ItemTemplate>
			<ItemStyle  CssClass="tdbg" HorizontalAlign="Center" />
		</asp:TemplateField>
	</Columns>              
