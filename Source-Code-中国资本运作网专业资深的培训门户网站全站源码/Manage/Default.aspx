<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_emmhtgtv" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html>
<head>
...
<div class="col-lg-9 col-md-10 col-sm-9 col-xs-12 hidden-xs"> 
    ...
    <div class="pull-right hidden-lg hidden_group" id="search_div">
        <div class="input-group input-group-sm">
            <asp:TextBox runat="server" ID="keyText" class="form-control input-control" placeholder="快速搜索" onkeydown="return IsEnter(this);" /><i class="glyphicon glyphicon-search"></i>
        </div>
    </div>
    </div>
</div>
...
<ul class="menu10">
	...
	<li class="menu10_2"><a onclick="showleft('menu10_2','WeiXin/WxAppManage.aspx')"><%:lang.LF("微信应用") %></a></li>
    <li class="menu10_3"><a onclick="showleft('menu10_3','WeiXin/PayWeiXin.aspx')"><%:lang.LF("微信支付") %></a></li>
    <li class="menu10_4"><a onclick="showleft('menu10_4','WeiXin/WxAppManage.aspx')"><%:lang.LF("微信配置") %></a></li>
...
<div id="left_ul_div">
	...
	<%--		<li id="menu5_2_2"><a href="javascript:;" data-url="Exam/ScoreStatics.aspx"><%:lang.LF("成绩统计") %></a> </li>--%>
		...
		<ul class="m_left_ulin" id="menu5_7">
			...
			<li id="menu5_7_1"><a href="javascript:;" data-url="Exam/Papers_System_Manage.aspx">试卷管理</a></li>
			<li id="menu5_7_2"><a href="javascript:;" data-url="Exam/QuestionManage.aspx">试题管理</a></li>
<%--			<li id="menu5_7_3"><a href="javascript:;" data-url="Exam/AddQuestion.aspx?Operation=Add"><%:lang.LF("添加试题") %></a></li>--%>
			<li id="menu5_7_4"><a href="javascript:;" data-url="Exam/Question_Class_Manage.aspx">试题分类</a></li>
	...
	<div id="menu6" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu6_7">
			...
			<li id="menu6_7_6"><a href="javascript:;" data-url="Shop/ProductManage.aspx"><%:lang.LF("虚拟商品管理") %></a></li>
 ...
 <%--           <li id="menu9_8_6"><a href="javascript:;" data-url="Plus/AuditNotes.aspx">审核记录</a></li>--%>
    ...
    <div id="menu10" class="m_left_ul">
		<ul class="m_left_ulin open" id="menu10_1">
            ...
            <li id="menu10_1_2"><a href="javascript:;" data-url="/APP/AddTemplate.aspx"><%:lang.LF("移动APP") %></a></li>
            <li id="menu10_1_3"><a href="javascript:;" data-url="http://wei.zoomla.cn/"><%:lang.LF("移动模拟器") %></a></li>
        </ul>
        <ul class="m_left_ulin" id="menu10_2">
            <li class="menu_tit"><span class="glyphicon glyphicon-globe"></span>微信应用</li> 
            <li id="menu10_2_1"><a href="javascript:;" data-url="WeiXin/WxAppManage.aspx"><%:lang.LF("公众号码") %></a></li> 
            <li id="menu10_2_2"><a href="javascript:;" data-url="WeiXin/SendWx.aspx"><%:lang.LF("消息群发") %></a></li>
            <li id="menu10_2_3"><a href="javascript:;" data-url="WeiXin/MsgsSend.aspx"><%:lang.LF("图文群发") %></a></li>
            <li id="menu10_2_4"><a href="javascript:;" data-url="WeiXin/WxMaterial.aspx?type=news"><%:lang.LF("素材中心") %></a></li>
            <li id="menu10_2_5"><a href="javascript:;" data-url="WeiXin/PayWeiXin.aspx"><%:lang.LF("微信支付") %></a></li> 
        </ul>
        <ul class="m_left_ulin" id="menu10_3">
            <li class="menu_tit"><span class="glyphicon glyphicon-globe"></span>微信支付</li> 
            <li id="menu10_3_1"><a href="javascript:;" data-url="WeiXin/QrCodeManage.aspx"><%:lang.LF("二维扫码") %></a></li> 
            <li id="menu10_3_2"><a href="javascript:;" data-url="WeiXin/QrCodeDecode.aspx"><%:lang.LF("解码管理") %></a></li>
            <li id="menu10_3_3"><a href="javascript:;" data-url="AddOn/UAgent.aspx"><%:lang.LF("设备接入") %></a></li> 
        </ul>
        <ul class="m_left_ulin" id="menu10_4">
            <li class="menu_tit"><span class="glyphicon glyphicon-globe"></span>微信配置</li> 
            <li id="menu10_4_1"><a href="javascript:;" data-url="WeiXin/WxConfig.aspx"><%:lang.LF("微信配置") %></a></li>
        </ul>
