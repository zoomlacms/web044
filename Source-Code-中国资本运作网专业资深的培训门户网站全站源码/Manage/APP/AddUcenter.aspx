<%@ page language="C#" autoeventwireup="true" inherits="manage_APP_AddUcenter, App_Web_fy0lnko0" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
     <table class="table table-striped table-bordered table-hover">
      ...
      <tr>
        <td class="td_l">网站域名:</td>
        <td><asp:TextBox ID="TxtWebSite" class="form-control text_300" runat="server" placeholder="www.zoomla.cn" />
         ...
         <tr><td>App Key:</td><td><asp:Label runat="server" ID="Key_L" /></td></tr>
         <tr><td>用户管理:</td>
             <td>
             ...
             <tr><td>启用</td><td><input type="checkbox" runat="server" id="Status_Chk" checked="checked" class="switchChk" /></td></tr>
         <tr><td></td><td>
