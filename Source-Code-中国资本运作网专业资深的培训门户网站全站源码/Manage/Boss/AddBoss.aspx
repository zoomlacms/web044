<%@ page language="C#" autoeventwireup="true" inherits="manage_Boss_AddBoss, App_Web_xdqlxvtq" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <table class="table table-striped table-bordered table-hover">
                    <tbody id="Tabs0">
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="CMoney" runat="server"   CssClass="form-control text_300"></asp:TextBox>元
                    ...
                    <tbody id="Tabs1" style="display: none">
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="ContractNum" runat="server"  CssClass="form-control text_300"></asp:TextBox>
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="AccountPeople" runat="server" CssClass="form-control text_300" ></asp:TextBox>
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="Bank" runat="server" CssClass="form-control text_300" ></asp:TextBox>
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="BankNum" runat="server" CssClass="form-control text_300" ></asp:TextBox>
                    ...
                    <tbody id="Tabs2" style="display: none">
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="PostCode" runat="server" CssClass="form-control text_300" ></asp:TextBox>
                        ...
                        <tr class="tdbg">
                            ...
                            <td>
                                <asp:TextBox ID="DocumentsNUm" runat="server" CssClass="form-control text_300" ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server"
