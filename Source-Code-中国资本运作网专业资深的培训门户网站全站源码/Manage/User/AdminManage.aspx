<%@ page language="C#" autoeventwireup="true" inherits="ZoomLaManage.WebSite.Manage.User.AdminManage, App_Web_vvvftkqm" title="管理员管理" tracemode="SortByCategory" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head"><title>管理员管理</title><style>.breadcrumb{line-height:30px;}</style></asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
        ...
        <div class="row">
            ...
            <div id="sel_box" class="padding5">
                <div class="input-group sel_box">
                    <asp:TextBox runat="server" ID="Search_T" class="form-control" placeholder="Enter your search here" />
                    <span class="input-group-btn">
                         <asp:LinkButton runat="server" CssClass="btn btn-default" ID="Search_Btn" OnClick="Search_Btn_Click">Search</asp:LinkButton>
    ...
    <ZL:ExGridView ID="EGV" runat="server" AllowPaging="True" AutoGenerateColumns="False" OnPreRender="EGV_PreRender"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="多点登录" ItemStyle-HorizontalAlign="Center">
            ...
            <asp:BoundField HeaderText="创建时间" DataField="CDate" ItemStyle-HorizontalAlign="Center" />
