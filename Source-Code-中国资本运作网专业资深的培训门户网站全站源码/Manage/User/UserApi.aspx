<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.UserApi, App_Web_vvvftkqm" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-bordered">
                <tr><td class="td_l">主站数据库服务器IP：</td><td><asp:TextBox runat="server" ID="ServerIP_T" Text="127.0.0.1" CssClass="form-control required ip text_md" data-enter="1"/></td></tr>
                <tr><td>数据库名称：</td><td><asp:TextBox runat="server" ID="DBName_T" CssClass="form-control required text_md" data-enter="2"/></td></tr>
                <tr><td>数据库用户：</td><td><asp:TextBox runat="server" ID="UName_T" CssClass="form-control required text_md" data-enter="3"/></td></tr>
                <tr><td>数据库密码：</td><td><asp:TextBox runat="server" ID="Pwd_T" data-enter="4" CssClass="form-control required text_md"/></td></tr>
                <tr><td>服务器Token：</td><td><asp:TextBox runat="server" ID="Token_T" CssClass="form-control text_md" data-enter="5"/></td></tr>
                <tr><td class="td_l">是否子站：</td><td><input type="checkbox" runat="server" id="RemoteEnable" class="switchChk" /></td></tr>
