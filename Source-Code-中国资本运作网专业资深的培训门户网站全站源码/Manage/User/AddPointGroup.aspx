<%@ page language="C#" autoeventwireup="true" inherits="manage_User_AddPointGroup, App_Web_2ozwkmyo" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table width="100%" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txt_imgUrl" runat="server" class="form-control text_md" ></asp:TextBox>
