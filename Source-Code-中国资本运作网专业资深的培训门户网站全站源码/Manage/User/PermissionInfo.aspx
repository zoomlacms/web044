<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_PermissionInfo, App_Web_vvvftkqm" enableviewstate="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="20"   EmptyDataText="无数据"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="相关操作">
                <ItemTemplate>
                    <a href="Permissionadd.aspx?menu=edit&id=<%#Eval("ID") %>">修改</a>　<a href="Permissionadd.aspx?menu=del&id=<%#Eval("ID") %>" onclick="return confirm('确实要删除此角色吗？');">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="CompetenceAdd.aspx?id=<%#Eval("ID") %>" >权限设置</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="SelUsersToRole.aspx?id=<%#Eval("ID") %>" >用户管理</a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
