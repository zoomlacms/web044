<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_CompetenceAdd, App_Web_vvvftkqm" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        <tr>
            <td colspan="2" class="text-center"><b>角色权限设置</b></td>
        </tr>
        <tr>
            <td class="text-right" style="width: 200px;">部门名：</td>
