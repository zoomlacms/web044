<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.Group, App_Web_2ozwkmyo" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <tr>
      ...
      <tr>
          <td class="tdbgleft"><strong>是否为教师：</strong></td>
          <td>
              <input type="checkbox" runat="server" id="txt_Teach" class="switchChk" />
          </td>
      </tr>
    <tr>
