<%@ page language="C#" autoeventwireup="true" inherits="ZoomLaManage.WebSite.Manage.User.AddManage, App_Web_vvvftkqm" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="tab-content" >
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:HiddenField runat="server" ID="Theme_Hid" />
                    </td>
                </tr>
        ...
        <div class="tab-pane" id="profile">
            <table class="table table-striped table-bordered table-hover">
                <tr>
                    <td class="td_l"><strong>管理员角色设置：</strong></td>
                    <td>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        function ShowAD() {
            ShowComDiag("../Scence.aspx?Source=admin", "场景设置");
        }
        function SetConfig(config) {
            $("#Theme_Hid").val(config);
