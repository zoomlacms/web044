<%@ page language="C#" autoeventwireup="true" inherits="Manage_Plus_TxtLog, App_Web_ditt5i2n" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div id="egvdiv" runat="server">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="操作">
                <ItemTemplate>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Name") %>' CommandName="view">查看</asp:LinkButton>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Name") %>' CommandName="down">下载</asp:LinkButton>
                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Name") %>' CommandName="del2">删除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </ZL:ExGridView>
