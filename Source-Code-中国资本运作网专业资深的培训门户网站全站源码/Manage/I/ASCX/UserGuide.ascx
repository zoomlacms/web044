<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_UserGuide, App_Web_odscpodd" %>
<div class="tvNavDiv">
...
<ul class="m_left_ulin">
    ...
    <li><a onclick="ShowMain('','')">财务管理</a></li>
    <li><a onclick="ShowMain('','User/PointGroup.aspx')"><%=lang.LF("积分等级")%></a></li>
    <li><a onclick="ShowMain('','User/DepositManage.aspx')">用户提现</a></li>
    <li><a onclick="ShowMain('','Shop/PVManager.aspx')">订单提成</a></li>
    <li><a onclick="ShowMain('','User/UnitMain.aspx')">会员提成</a></li>
