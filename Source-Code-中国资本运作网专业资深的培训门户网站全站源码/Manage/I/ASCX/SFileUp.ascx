<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_SingelFileUp, App_Web_odscpodd" clientidmode="Static" %>
<asp:TextBox runat="server" ID="FVPath_T" CssClass="form-control" style="max-width:300px;"></asp:TextBox>
<button type="button" id="fileup_b" class="btn btn-primary">选择</button>
