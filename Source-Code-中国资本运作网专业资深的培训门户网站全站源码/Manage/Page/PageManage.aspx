<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_PageManage, App_Web_3jwwvd1l" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <ZL:ExRepeater ID="RPT" runat="server" PageSize="10"  PagePre="<tr id='page_tr'><td colspan='11''><label class='allchk_l'><input type='checkbox' id='chkAll'/>全选</label><div class='text-center'>" PageEnd="</div></td></tr>">
            <ItemTemplate>
                <tr id="<%#Eval("ID") %>" ondblclick="getinfo(this.id)">  
                    ...
                    <td align="center"><a href="AuditUser.aspx?menu=view&id=<%#Eval("ID")%>"><%#Eval("UserName")%></a></td>
