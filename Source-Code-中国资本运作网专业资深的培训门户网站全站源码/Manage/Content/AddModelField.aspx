<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddModelField, App_Web_chetbuey" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<tr>
	...
	<td>
		<asp:TextBox ID="Description" Style="height:78px;" CssClass="form-control text_300" runat="server" TextMode="MultiLine"></asp:TextBox>
	</td>
</tr>
<%--<tr runat="server" visible="false">
    <td><strong>操作权限:</strong></td>
    <td>
         <asp:TextBox runat="server" ID="EditAuth_T" ReadOnly="true"  Style="height:78px;" CssClass="form-control text_300" TextMode="MultiLine"></asp:TextBox>
...
<tbody id="DivOptionType" style="display: none" runat="server">
	<tr>
		...
		<td>
			...
			<asp:TextBox ID="RadioType_Content" runat="server" Style="margin-top: 5px;" TextMode="MultiLine"  CssClass="form-control text_300" Height="80px"></asp:TextBox>
	...
	<tr>
		...
		<td>
			<asp:TextBox ID="RadioType_Default" CssClass="form-control text_300"  runat="server"></asp:TextBox>
