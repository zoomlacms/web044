<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddEditModel, App_Web_chetbuey" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
	...
	<tr class="tdbg">
		...
		<td>
			<asp:TextBox ID="TxtModelName" class="form-control pull-left" onchange="checkTbName()" runat="server" Width="156" MaxLength="200" onkeyup="Getpy('TxtModelName','TxtTableName')" />
            <span class="spanl_30">
