<%@ page language="C#" autoeventwireup="true" inherits="Manage_Content_Video_VideoInfo, App_Web_adv3saos" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="VName_T" CssClass="form-control text_300" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
