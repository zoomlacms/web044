<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="ZoomLa.WebSite.Manage.Config.UserConfig, App_Web_rtgslmvf" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover myform-control">
	<tbody id="Tabs0">
		...
		<tr>
			...
			<td>
                <input type="checkbox" runat="server" id="radioMobile" class="switchChk" />
            </td> 
		</tr>
		<tr>
