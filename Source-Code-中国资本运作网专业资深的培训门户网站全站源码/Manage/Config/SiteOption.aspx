<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_SiteOption, App_Web_rtgslmvf" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table class="table table-striped table-bordered table-hover">
	<tbody>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="Savanumlog" runat="server"  CssClass="form-control text_300"></asp:TextBox>
				<span>条 (<%:lang.LF("0-不限制") %>)</span></td>
		</tr>
		<tr>
			<td><strong><%:lang.LF("保留日志天数") %>：</strong></td>
			<td>
				<asp:TextBox ID="Savadaylog"  runat="server" CssClass="form-control text_300"></asp:TextBox>
		...
		<tr runat="server" id="Tr1">
			...
			<td>
				<asp:TextBox ID="Videourl" runat="server" CssClass="form-control text_300"></asp:TextBox></td>
		</tr>
		<tr>
			<td><strong><%:lang.LF("评论积分赠送") %>：</strong></td>
			<td>
				<asp:TextBox ID="CommentRule"  runat="server" CssClass="form-control text_300"></asp:TextBox>
				<span>分</span>
			</td>
		</tr>
		<tr>
			...
			<td>
				<asp:TextBox ID="txtPdf" runat="server"  CssClass="form-control text_300"></asp:TextBox>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="txtAdvertisementDir"  runat="server" CssClass="form-control text_300"></asp:TextBox>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="MastMoney" runat="server"  CssClass="form-control text_300"></asp:TextBox></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="txtCatalog" runat="server"  CssClass="form-control text_300"></asp:TextBox>
...
<table class="table table-striped table-bordered table-hover">
	<tbody>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="txtProjectServer" Width="200" runat="server" CssClass="form-control text_300"></asp:TextBox>
				<span class="rspan">提示：支持从远程云端下载功能与模板界面，官方服务器地址：http://updata.zoomla.cn</span></td>
		</tr>
		<tr>
			<td><strong><%:lang.LF("网站首页模板") %>：</strong></td>
			<td>
			  <%--  <asp:TextBox ID="TxtIndexTemplate" Width="200" runat="server" CssClass="form-control text_300 pull-left"></asp:TextBox>--%>
		...
		<tr>
			...
			<td>
				<div id="DivCssDir">
					<asp:TextBox ID="txtCssDir" runat="server" Width="200" CssClass="form-control text_300 pull-left" style="display:inline;"></asp:TextBox>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="txtStylePath" Width="200" runat="server" CssClass="form-control text_300 pull-left"></asp:TextBox></td>
		</tr>
	</tbody>
</table>
</div>
...
<table class="table table-striped table-bordered table-hover">
	<tbody>
		<tr>
			...
			<td>
				<asp:TextBox ID="txtSiteManageCode" runat="server" CssClass="form-control text_300"></asp:TextBox></td>
		</tr>
<%--                    <tr>
		...
		<tr runat="server" id="Tr2">
			...
			<td>
				<asp:TextBox ID="FlexKey" Width="360px" runat="server" CssClass="form-control text_300 pull-left"></asp:TextBox>
			</td>
		</tr>
		<tr>
		...
		<tr style="display: none">
			...
			<td>
				<asp:TextBox ID="TxtSensitivity" runat="server" Rows="6" TextMode="MultiLine" CssClass="form-control text_300"></asp:TextBox>
				&nbsp;提示：敏感词汇请用","分隔 </td>
		</tr>
        <tr>
...
<table class="table table-striped table-bordered table-hover">
	<tbody>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="txtUploadFileMaxSize" Text="30" runat="server" CssClass="form-control text_300"></asp:TextBox>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="TxtUpMediaSize" runat="server" CssClass="form-control text_300"></asp:TextBox>
				&nbsp;<span>KB
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="TxtUpFlashSize" runat="server" CssClass="form-control text_300"></asp:TextBox>
				&nbsp;<span>KB
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="txtUploadDir" runat="server" CssClass="form-control text_300 pull-left"></asp:TextBox></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="TxtUpPicSize" runat="server" Width="300" CssClass="form-control text_300"></asp:TextBox>
				&nbsp;<span>KB
		  提示：1 KB = 1024 Byte，1 MB = 1024 KB</span> </td>
		</tr>
		<tr>
...
<table class="table table-striped table-bordered table-hover">
	<tbody>
		...
		<tr>
			...
			<td>
				<asp:TextBox ID="txtSetPrice" runat="server" CssClass="form-control text_300"></asp:TextBox>
		...
		<tr>
			...
			<td>
				...
				<span id="Api" runat="server">
					<asp:TextBox ID="TB_Api" runat="server" CssClass="form-control text_300"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="ReturnDate_T" runat="server" CssClass="form-control text_300" Text="10"></asp:TextBox>
