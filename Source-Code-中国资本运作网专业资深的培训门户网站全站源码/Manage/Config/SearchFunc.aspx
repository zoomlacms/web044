<%@ page language="C#" autoeventwireup="true" inherits="manage_Search_SearchFunc, App_Web_rtgslmvf" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ul class="nav nav-tabs" id="linktype_ul">
      <li data-id="0" role="presentation" ><a href="SearchFunc.aspx">全部</a></li>
      <li data-id="1" role="presentation"><a href="SearchFunc.aspx?linktype=1">快速导航</a></li>
      <li data-id="3" role="presentation"><a href="SearchFunc.aspx?linktype=3">用户中心</a></li>
    </ul>
    <div>
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        $().ready(function () {
            ...
            $("#linktype_ul [data-id='" + linktype + "']").addClass('active');
        })
    </script>
</asp:Content>
