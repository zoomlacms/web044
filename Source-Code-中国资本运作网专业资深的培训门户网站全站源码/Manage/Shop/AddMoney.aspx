<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.AddMoney, App_Web_tkdtaxq4" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td width="82%">
                <select name="unname" class="form-control text_md" onchange="chgcur(options[this.selectedIndex].value)" id="moneydescp" runat="server">
        ...
        <tr>
            ...
            <td width="82%">
                <asp:TextBox ID="moneycode" class="form-control text_md" runat="server" onKeyUp="backText()"></asp:TextBox><span
        ...
        <tr>
            ...
            <td width="82%">
                <asp:TextBox ID="moneysign" class="form-control text_md" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="82%">
                <asp:TextBox ID="moneyrate" class="form-control text_md" runat="server" onKeyUp=" value=value.replace(/[^+|.|0-9]/g,'')"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width: 200px; height: 23px;">
