<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Orderlistinfo, App_Web_wvgshvlq" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
                ...
                <td colspan="11">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="50%" align="right" style="height: 19px">&nbsp;已付款：<asp:Label ID="Label28" runat="server"></asp:Label></td>
                        </tr>
                    </table>
                </td>
            </tr>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td>合计：<asp:Label ID="Label3" runat="server"></asp:Label>
            </td>
            <td>其他费用：<asp:Label ID="Label4" runat="server"></asp:Label>
            </td>
            <td>代购服务费：<asp:Label ID="Label5" runat="server"></asp:Label>
            </td>
            <td>付款状态：<asp:Label ID="Label6" runat="server"></asp:Label>
      <%--          <asp:Button ID="Button1" CssClass="btn btn-primary"  runat="server" Text="修改为已付款"
                    Enabled="false" OnClientClick="return confirm('确定要修改付款状态吗？');" OnClick="Button1_Click" />--%>
                <asp:Button ID="buttonorder" CssClass="btn btn-primary"  runat="server"
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td width="20%">
                <asp:Button ID="Button4" CssClass="btn btn-primary" runat="server" Text="确认订单" OnClick="Button4_Click" />
            </td>
            <td width="20%">
                <asp:Button ID="Button2" CssClass="btn btn-primary" runat="server" Text="已经支付" OnClick="Button2_Click" OnClientClick="return confirm('确定修改订单状态吗,充值,IDC等将会完成充值操作!');" />
            </td>
            <td width="20%">
        ...
        <tr>
            <td>
                <asp:Button ID="Button5" CssClass="btn btn-primary"  runat="server" Text="取消确认" OnClick="Button5_Click" />
            </td>
            <td>
                <asp:Button ID="Button7" CssClass="btn btn-primary"  runat="server" Text="客户已签收"
            ...
            <td>
                <asp:Button ID="Button11" CssClass="btn btn-primary"  runat="server" Text="开发票"
                    OnClick="Button11_Click" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Button ID="Button3" CssClass="btn btn-primary"  runat="server" Text="发货" OnClientClick="show();return false;" />
            </td>
            <td>
