<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddProduct, App_Web_tkdtaxq4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
                ...
                <table class="table table-striped table-bordered">
                    <tbody id="Tabs0" style="border-top:none;">
                        ...
                        <tr>
                            ...
                            <td style="height: 26px;">
                                <asp:Button ID="Button3" class="btn btn-info" runat="server" Text="添加捆绑商品" OnClientClick="OpenSelect();return false;" />
                                <asp:Button ID="Button4" class="btn btn-info" runat="server" Text="清空捆绑列表" OnClientClick="ClearSelect();return false;" /><br />
                                            ...
                                            <table id="tgTable" class="classdiv">
                                                ...
                                                <tr>
                                                    <td colspan="4" align="center">
                                                        <asp:Button ID="Button14" class="btn btn-info" Style="width: 100px" runat="server" Text="添加" CausesValidation="false" OnClick="Button14_Click" />
                                                        <asp:Button ID="Button15" class="btn btn-info" Style="width: 100px" runat="server" Text="浏览价格"
                    ...
                    <tbody id="Tabs5" style="border-top:none;display: none">
                        <tr id="addChild_TR" runat="server" visible="false">
                            ...
                            <td><button type="button" onclick="ShowShopList('<%=ProID %>',<%=NodeID %>)" class="btn btn-info">查看子商品</button> <a href="AddProduct.aspx?pid=<%=ProID %>&ModelID=<%=ModelID %>&NodeID=<%=NodeID %>" class="btn btn-info">添加子商品</a></td>
                        </tr>
