<%@ page language="C#" autoeventwireup="true" inherits="Zone_ChatStart, App_Web_mqno5cjw" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>黑灯瞎火蒙面聊</title>
...
<form id="form1" runat="server">
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
      <td><asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
