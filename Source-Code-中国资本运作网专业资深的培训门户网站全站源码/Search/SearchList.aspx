<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.SearchList, App_Web_5nf3bwtk" enableviewstate="false" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE HTML>
<html lang="zh-cn">
<head>
<meta charset="utf-8" />
...
<script>
    ...
    function LoadPage() {
        ...
        $("#rpt_div").load("SearchBody.aspx?keyword=" + skeyMod.keywrod + "&node=" + skeyMod.node + "&order=" + skeyMod.order + " #main");
    }
