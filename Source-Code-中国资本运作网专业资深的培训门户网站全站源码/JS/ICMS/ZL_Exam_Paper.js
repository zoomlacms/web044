...
var litlp = "<li><div class='input-group'><span class='btn btn-default input-group-addon'>@op</span><input id='@op_t' type='text' class='form-control text_md' value='@val'></div></li>";
//生成指定数目的选项
...
function GetOptions() {
    ...
    for (var i = 0; i < $liarr.length; i++) {
        ...
        opMod.op = $li.find("span").text();
        opMod.val = $li.find("#" + opMod.op + "_t").val();
        oparr.push(opMod);
    }
