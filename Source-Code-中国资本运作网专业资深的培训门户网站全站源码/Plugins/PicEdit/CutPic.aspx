<%@ page language="C#" autoeventwireup="true" inherits="test_CutPic, App_Web_vzbaxw2z" enableEventValidation="false" viewStateEncryptionMode="Never" %><!DOCTYPE html>
<html>
<head>
                            ...
                            <div class="imgTextItem">
                                <ul class="list-unstyled" role="menu">
                                    ...
                                    <li><span class="pull-left" title="保持初始宽高比,避免图片变形" >
                                          ...
                                          <span class="pull-right"><input type="button" class="btn btn-default" onclick="ZoomFunc();" value="缩放图片"  /></span>
                                    </li>
                                    <div class="clearfix"></div>
                                    <li class="divider"></li>
                                    <li><h4>预设尺寸</h4></li>
