<%@ page language="C#" autoeventwireup="true" inherits="Guest_Bar_PostContent, App_Web_htyb3cwf" masterpagefile="~/Guest/Guest.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<script type="text/javascript" src="/test/js/jquery.stickem.js"></script>
<title><asp:Literal runat="server" ID="Title_L"></asp:Literal></title>
<style>.editdrop{min-width:100px;}</style>
</asp:Content>
