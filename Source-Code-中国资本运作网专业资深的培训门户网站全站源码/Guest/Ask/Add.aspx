<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Guest_AskAdd, App_Web_zj3vbfi3" clientidmode="Static" enableviewstatemac="false" masterpagefile="~/Guest/Ask/Ask.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:DropDownList ID="ddlCate" CssClass="form-control" style="float:left; display:inline-table;" runat="server" Width="200px" OnSelectedIndexChanged="ddlCate_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
